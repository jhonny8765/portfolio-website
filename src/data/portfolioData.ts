export const portfolioData = {
  identity: {
    ...
    shortBio: "I build websites, applications, and automations with AI. Currently growing into an advanced AI developer through hands-on projects.",
  ...
  projects: [
    {
      ...
      description: "A web application designed to help salon owners manage their appointments and services.",
      features: [
    ...
    },
    {
      ...
      description: "An agricultural product catalog and local-commerce experience serving farmers across Regions 11 and 12.",
      features: [
  ...
  services: [
    ...
    },
    {
      ...
      description: "Implementing practical AI features like grounded chatbots and automated content generation into existing systems."
    }
  ]
};
