    ...
    <section ref={container} className="relative w-full pt-16 pb-12 sm:pt-24">
      <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        <div className="z-10 flex flex-col items-start text-left">
          <div
            className="hero-text-item mb-6 inline-flex items-center gap-2 rounded-full border border-[var(--color-volt)]/30 bg-[var(--color-volt)]/5 px-3 py-1.5 text-xs font-semibold tracking-widest text-[var(--color-volt-light)] uppercase"
          ...
          <p
            className="hero-text-item mb-8 max-w-xl text-lg leading-relaxed text-[var(--text-secondary)] sm:text-xl"
          ...
          <div
            className="hero-text-item flex w-full flex-col items-center gap-4 sm:w-auto sm:flex-row"
          ...
          <div
            className="hero-text-item mt-3 flex items-center gap-1.5 font-mono text-xs text-[var(--color-volt-light)]/70"
            style={{ '--hero-delay': '0.42s' } as React.CSSProperties}
          >
          ...
          <div
            className="hero-text-item mt-5 flex items-center gap-3 text-sm text-[var(--text-secondary)]"
        ...
        <div className="hero-console relative z-10 mx-auto w-full max-w-lg lg:mx-0 lg:ml-auto">
          ...
          <div
            className="hero-floater pointer-events-none absolute -top-16 left-8 z-[10] hidden w-[160px] mix-blend-screen md:block lg:-top-20 lg:left-12 lg:w-[190px]"
            style={{ '--hero-delay': '0.3s' } as React.CSSProperties}
          >
            <Image
          ...
          <div
            className="hero-floater pointer-events-none absolute -top-12 -right-10 z-[10] hidden w-[130px] mix-blend-screen md:block lg:-top-16 lg:-right-14 lg:w-[150px]"
          ...
          <div
            className="hero-floater pointer-events-none absolute -right-8 -bottom-10 z-[10] hidden w-[120px] mix-blend-screen md:block lg:-right-12 lg:-bottom-12 lg:w-[140px]"
            style={{ '--hero-delay': '0.46s' } as React.CSSProperties}
          >
            <Image
          ...
          <div
            className="hero-console-window relative z-[2] overflow-hidden rounded-2xl border border-white/10 bg-[#090a0f]/95 shadow-2xl backdrop-blur-xl"
